...
class FingerprintBoundary {
    ...
    fun putFingerprint(artistsJson: String,
                       recordingTitle: String,
                       releaseTitle: String,
                       recordingId: UUID,
                       releaseGroupId: UUID): Fingerprint =
            DigestUtils.sha512Hex(artistsJson + recordingTitle + releaseTitle).let {
                ...
                } ?: Fingerprint(idgen.generateId(), userBoundary.getCurrentUser(), it, recordingId, releaseGroupId)
