...
--
-- Name: playback ix_playback_originaldata; Type: CONSTRAINT; Schema: public; Owner: cfmuser
--

ALTER TABLE ONLY playback
    ADD CONSTRAINT ix_playback_originaldata UNIQUE (original_data_oid);


--
-- Name: playback ix_playback_uuid; Type: CONSTRAINT; Schema: public; Owner: cfmuser
--

ALTER TABLE ONLY playback
    ADD CONSTRAINT ix_playback_uuid UNIQUE (uuid);
