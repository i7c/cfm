...
sub _mpd_connect {
    ...
    while() {
        ...
        my $data = {
            ...
            MUSICBRAINZ_ALBUMARTISTID   => $mpd_currentsong->{"MUSICBRAINZ_ALBUMARTISTID"},
            MUSICBRAINZ_ALBUMID         => $mpd_currentsong->{"MUSICBRAINZ_ALBUMID"},
            MUSICBRAINZ_RELEASETRACKID  => $mpd_currentsong->{"MUSICBRAINZ_RELEASETRACKID"},
            MUSICBRAINZ_TRACKID         => $mpd_currentsong->{"MUSICBRAINZ_TRACKID"},
            MUSICBRAINZ_ARTISTID        => $mpd_currentsong->{"MUSICBRAINZ_ARTISTID"},
